...
const Planets = () => {
    ...
    return (
        <>
            <div>
                <h2 className="tituloPlanets display-6 text-start fw-bold">Planets</h2>
                <div className=" contenedorPlanets d-flex">
                    {store.Planets.map((item, index) =>
                    (
                        <div key={index} className="cardPlanets card-container" >
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text textoPlanets">Rotation Period: {item.rotation_period}</p>
                                ...
                                <div className="d-flex-row">
                                    ...
                                    <button onClick={() => actions.favorito(item.name)} className="btn btn-outline-warning mx-5 ">


                                        {actions.colorBoton(item.name) ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
