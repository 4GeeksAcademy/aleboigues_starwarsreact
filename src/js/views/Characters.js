...
const Characters = () => {
    ...
    return (
        <>
            <div>
                <h2 className="tituloPersonajes display-6 text-start fw-bold">Personajes</h2>
                <div className="contenedorPersonajes d-flex">
                    {store.Characters.map((item, index) =>
                    (
                        <div key={index} className="cardPersonajes card-container" >
