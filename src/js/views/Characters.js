...
const Characters = () => {
    ...
    return (
        <> <div>
            <h2 className="tituloPersonajes display-6">Personajes</h2>            <div className=" contenedorPersonajes">                {store.Characters.map((item, index) => (
                <div key={index} className="cardPersonajes card-container" >
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">Color de ojos: {item.eye_color}</p>                        </div>
                </div>))}
            </div>
        </div >
        </>
