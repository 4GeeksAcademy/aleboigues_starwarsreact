...
const StarShip = () => {
    ...
    return (
        <>
            <div>
                <h2 className="tituloStarShip display-6 text-start fw-bold">StarShip</h2>
                <div className=" contenedorStarShip d-flex">
                    {store.StarShip.map((item, index) =>
                    (
                        <div key={index} className="cardStarShip card-container" >
